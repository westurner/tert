...
class TestShellcovBinary:
    ...
    def test_shellcov_generates_coverage_file(
        self, shellcov_binary, test_script, coverage_report_dir
    ):
    ...
    def test_coverage_file_contains_statistics(
        self, shellcov_binary, test_script, coverage_report_dir
    ):
    ...
    def test_cli_ux_displays_coverage_summary(
        self, shellcov_binary, test_script, coverage_report_dir
    ):
    ...
    def test_cli_ux_shows_missing_lines(
        self, shellcov_binary, test_script, coverage_report_dir
    ):
        ...
        if "100%" not in output:
            ...
            assert any(
                x in output.lower()
                for x in ["uncovered", "missing", "lines missing", "not covered"]
            )
    ...
    def test_line_range_formatting(
        self, shellcov_binary, test_script, coverage_report_dir
    ):
...
class TestShellcovIntegration:
    ...
    def test_shellcov_with_verbose_mode(
        self, shellcov_binary, test_script, coverage_report_dir
    ):
